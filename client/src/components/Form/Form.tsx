...
const FormComponent = ({ registration, form }: FormComponentProps) => {
    ...
    const loginForm = <Form layout="vertical" onSubmit={handleSubmit}>
        <Form.Item>
    ...
    const registrationForm = <Form layout="vertical">
        <Form.Item>
            {getFieldDecorator('username', {
                rules: [{ required: true, message: 'Please input your username!' }],
            })(
